...
mx <- DAT$mx[DAT$Year == 2010]
xp <- 0:110
xc <- 0:110 * sqrt(2)

pdf("/home/triffe/git/EquilateralLexis/EquilateralLexis/Draft2/Figs/LineGraph.pdf",
        height=5, width = 7)
...
text(86,.12,"period view",pos=2)
text(86,.01, "cohort view",pos=4)
dev.off()
